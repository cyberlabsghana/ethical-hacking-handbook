      ...
      navbar: {
        ...
        items: [
          ...
          { to: '/blog', label: 'HackTheBox', position: 'left' },
               {to: '/blog', label: 'Security Tools', position: 'left'},  
                        { to: '/blog', label: 'Data Protection', position: 'left' },
        { to: '/blog', label: 'Hacking News', position: 'left' },   
                {to: '/blog', label: 'Job Board', position: 'right'},
        {to: '/blog', label: 'Digital Legal', position: 'right'},
